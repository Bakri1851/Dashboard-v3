...
\geometry{a4paper, includehead, includefoot, left=0.85in, right=0.85in, top=0.85in, bottom=0.85in} % Page margins, change as you need
\setlength{\emergencystretch}{3em} % absorb tight lines into spacing instead of overflowing the margin (hyphenation is off)
...
The contribution of this thesis is a live, session-scale, instructor-facing dashboard system for detecting student struggle and question difficulty, where every tunable component is trained and tested end-to-end against a second-opinion LLM rater which is reported together with a documented negative finding as well as the successes of the deployed system.
...
% \include{appendix-sections/formulae-derivation}z
