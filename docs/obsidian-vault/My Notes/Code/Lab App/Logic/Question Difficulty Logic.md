...
Academic foundations for the difficulty score: [[dannath_evaluating|Dannath et al.]] (task-level struggle detection in ITS), [[frederikbaucks_2024_gaining|Baucks et al.]] (IRT for course difficulty analysis), [[pankiewicz_measuring|Pankiewicz]] (difficulty measurement in multi-attempt environments). Weighted-composite construction follows [[oecd_2008_handbook|OECD/JRC 2008]] and [[nardo_2005_tools|Nardo et al. 2005]]. See [[Ch2 – Background and Requirements]] for the full literature review and [[Ch3 – Design and Modelling]] for the thesis model definition.

Academic foundations for mistake clustering: TF-IDF vectorisation follows [[salton_1968_computer|Salton & Lesk 1968]] and [[salton_1983_introduction|Salton & McGill 1983]], with [[manning_2008_introduction|Manning, Raghavan & Schütze 2008]] as the modern reference; K-means clustering originates in [[macqueen_1967_some|MacQueen 1967]] with Lloyd's iteration in [[lloyd_1982_least|Lloyd 1982]] and the `k-means++` initialiser from [[arthur_2007_kmeanspp|Arthur & Vassilvitskii 2007]]; auto-k via silhouette score follows [[rousseeuw_1987_silhouettes|Rousseeuw 1987]]. The LLM-as-labeler step is grounded in [[zheng_2023_judging|Zheng et al. 2023]], [[gilardi_2023_chatgpt|Gilardi et al. 2023]], and the education-specific framing in [[kasneci_2023_chatgpt|Kasneci et al. 2023]].
