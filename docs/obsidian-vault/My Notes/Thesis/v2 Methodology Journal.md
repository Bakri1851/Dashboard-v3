...
|---|---|---|---|
| Struggle model (7 OLS weights) | **v2** | ρ +0.573 [+0.430, +0.715]; `n_hat`, `t_hat`, `rep_norm` sign-flipped | 4a |
| Difficulty model (5 OLS weights) | **v1** | v2 ρ +0.287 (< random); LR fits noise at N=72 | 4b |
| Improved-struggle model (3 OLS weights) | **v1** | v2 ρ +0.168; LR flipped $w_M$ and $w_D$ negative | 4c |
