...
## Connections
- [[Persist a single session record to the local JSON store.]] - `rationale_for` [EXTRACTED]
- [[_write_saved_sessions_payload()]] - `calls` [EXTRACTED]
- [[data_loader.py]] - `contains` [EXTRACTED]
- [[load_saved_sessions()]] - `calls` [EXTRACTED]
